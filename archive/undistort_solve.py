...
def distort_xy(up, vp, cam_num):
    param_lst = [[-0.27130810574978376, 0.12353492396888929, -0.034139519690971919, 870.14531487461625, 949.42001822880479, 870.14531487461625, 487.20049852775117],
    ...
    k1, k2, k3, fx, cx, fy, cy = param_lst[cam_num]

    xp = (up-cx)/fx
    yp = (up-cy)/fy

    x, y, r_2 = symbols('x, y, r_2')
    print(nonlinsolve([x**2 + y**2 - r_2, (1 + k1*r_2 + k2*r_2**2 + k3*r_2**3) * x - xp, (1 + k1*r_2 + k2*r_2**2 + k3*r_2**3) * y - yp], (x, y, r_2)))
